    ...
    <>
      ...
      <div className={darkMode === false ? "history" : "history-dark"}>
        <div
          className={
            darkMode === false
              ? "convex history-convex"
              : "convex-dark history-convex-dark"
          }
        >
          <h2 className={darkMode === false ? "gray" : "green"}>
            Wykres aktywności
          </h2>
          <div className={darkMode === false ? "chart" : "chart-dark"}>
            <div className={darkMode === false ? "column" : "column-dark"}>
              ...
              <div
                className={
                  darkMode === false
                    ? "progress-bar concave"
                    : "progress-bar-dark concave-dark"
                }
              >
                <div
                  className={darkMode === false ? "fill" : "fill-dark"}
          ...
          <div
            className={darkMode === false ? "history-sum" : "history-sum-dark"}
          >
        ...
        <div
          className={
            darkMode === false
              ? "convex history-container"
              : "convex-dark history-container-dark"
          }
        >
          ...
          {history.length === 0 ? (
            ...
            <>
              <table className={darkMode === false ? "table" : "table-dark"}>
                <tr
                  className={
                    darkMode === false ? "table-header" : "table-header-dark"
                  }
                >
                  <th>Id</th>
                  <th>Nazwa</th>
